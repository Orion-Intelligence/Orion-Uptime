  ...
  },
  {
    ...
    rules: {
      ...
      'no-restricted-syntax': [
        ...
        {
          selector: "Property[key.name='template']",
          message: 'Do not use inline templates. Use templateUrl with a separate .html file.'
        },
        {
          selector: "Property[key.name='styles']",
          message: 'Do not use inline component styles. Styling belongs in tailwind classes.'
        },
        {
          selector: "Property[key.name='styleUrls']",
          message: 'Do not use component stylesheets. Styling belongs in tailwind classes.'
        },
        {
          selector: "Property[key.name='styleUrl']",
          message: 'Do not use component stylesheets. Styling belongs in tailwind classes.'
        }
      ],
    },
