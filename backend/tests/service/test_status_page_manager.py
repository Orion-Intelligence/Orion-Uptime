...
from orion.services.mongo_manager.shared_model.db_status_page_model import CreateStatusPageRequest, UpdateStatusPageRequest
...
def _manager(monitors=None, overviews=None, response_time=None, incidents=None):
    ...
    manager = StatusPageManager(engine, monitor_service, _dashboard(overviews or [], response_time, incidents))
