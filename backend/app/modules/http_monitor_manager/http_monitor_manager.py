...
from app.service.mongo_db.shared_models.db_http_monitor_model import HTTP_monitorResponse, HTTPMonitorModel
...
class HTTP_monitorManager(MonitorRepository):
    def __init__(self, engine: AIOEngine):
        self.collection = engine.database[Collections.HTTP_MONITORS]

    async def create_monitor(self, name: str, url: str, check_interval: int, timeout: int, expected_status_code: int, expected_response_time_ms: int | None) -> HTTP_monitorResponse:
