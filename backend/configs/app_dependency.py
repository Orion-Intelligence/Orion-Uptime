...
class AppDependency:
    def create_access_token(self, user_id: str, username: str, role: UserRole) -> str:
        ...
        payload = {"sub": user_id, "username": username, "role": role.value, "type": TokenType.ACCESS.value, "exp": expire, "jti": uuid.uuid4().hex}
    ...
    def create_refresh_token(self, user_id: str, username: str, role: UserRole) -> tuple[str, datetime]:
        ...
        payload = {"sub": user_id, "username": username, "role": role.value, "type": TokenType.REFRESH.value, "iat": issued_at, "exp": expires_at, "jti": uuid.uuid4().hex}
